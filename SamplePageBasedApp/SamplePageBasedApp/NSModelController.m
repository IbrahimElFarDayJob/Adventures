...
{   
    ...
    NSDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"NSDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(NSDataViewController *)viewController];
